...
#folder_files=client.conditional_operation(container_name='rawdata',blob_name='raw',creation_date='2023-12-15',comparison='greater_than',action='download',file_regex='c*',path='download')
...
# files=client.conditional_filter(container_name='rawdata',blob_name='raw',creation_date='2023-12-15',comparison='greater_than',file_regex='c*')
# print(files)
...
#status=client.copy_blob(container_name='rawdata',blob_name='raw',destination_container='rawdata',destination_blob='new_copy',all_files=True,file_regex='c*')
#status=client.copy_blob(container_name='rawdata',blob_name='raw',destination_container='rawdata',destination_blob='new_copy',all_files=True)
#print(status)
...
#client.download_file(container_name='rawdata',blob_name='new_copy',path='downloaded',all_files=True)
...
#client.delete_file(container_name='rawdata',blob_name='test',all_files=True)
